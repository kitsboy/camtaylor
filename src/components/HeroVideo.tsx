...
export const HeroVideo: React.FC = () => {
  ...
  return (
    /* The entrance used to slide in from `x: 28`, inside a `overflow: hidden`
       shell 22px wider than its content box — so for the first second of every
       page load the frame's right edge was clipped, and the shell's own
       `scrollWidth` was 20px past its `clientWidth` while the spring ran. It
       read as a pass only because the shell's padding was one pixel luckier
       than the animation. Coming up from below cannot overflow sideways at any
       frame, and nothing gets cut on the way in. */
    <motion.div
